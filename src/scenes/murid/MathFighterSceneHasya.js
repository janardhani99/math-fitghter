...
export default class MAthFighterScene extends Phaser.Scene{
    ...
    gameStart()
    {
        ...
        this.questiontText = this.add.text(this.gameHalfWidth, 100,  '0', { fontSize : '32px', fill: '#000'})
    ...
    generateQuestion() {
       ...
       this.questiontText.setText(this.question[0])
       const textHalfWidth = this.questionText.width * 0.5 
       this.questiontText.setX(this.gameHalfWidth - textHalfWidth)
    }
